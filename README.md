...
```bash
# リポジトリのクローン
git clone https://github.com/kenyan14159/nssu-ekiden.git
cd nssu-ekiden
...
**mainブランチにpushすると自動でエックスサーバーにデプロイされます。**
...
デプロイ状況は [GitHub Actions](https://github.com/kenyan14159/nssu-ekiden/actions) で確認できます。

### デプロイ設定

詳細な設定方法は以下のドキュメントを参照してください：

- 📘 **[クイックスタート](./docs/DEPLOY_QUICKSTART.md)** - 5分で設定完了
- 📗 **[詳細設定ガイド](./docs/DEPLOY_SETUP.md)** - トラブルシューティング含む完全版
...
- **ウェブサイト**: https://nssu-ekiden.com
- **GitHub Issues**: https://github.com/kenyan14159/nssu-ekiden/issues
