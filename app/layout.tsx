...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://nssu-ekiden.works/wp-content/uploads/2025/02/nssuimageog.jpeg',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: '日本体育大学駅伝部 | 公式ホームページ',
    description: '日体大駅伝部の公式サイトです。箱根駅伝、全日本大学駅伝への挑戦、選手紹介、試合結果、記録を掲載しています。',
    images: ['https://nssu-ekiden.works/wp-content/uploads/2025/02/nssuimageog.jpeg'],
  },
  icons: {
    icon: [
      { url: 'https://nssu-ekiden.works/wp-content/uploads/2025/02/nssu16-1.jpg', sizes: '16x16', type: 'image/jpeg' },
      { url: 'https://nssu-ekiden.works/wp-content/uploads/2025/02/nssu32-1.jpg', sizes: '32x32', type: 'image/jpeg' },
      { url: 'https://nssu-ekiden.works/wp-content/uploads/2025/02/nssu48-1.jpg', sizes: '48x48', type: 'image/jpeg' },
      { url: 'https://nssu-ekiden.works/wp-content/uploads/2025/02/nssu192.jpg', sizes: '192x192', type: 'image/jpeg' },
    ],
    apple: [
      { url: 'https://nssu-ekiden.works/wp-content/uploads/2025/02/nssu192.jpg', sizes: '180x180', type: 'image/jpeg' },
    ],
  },
  ...
  alternates: {
    canonical: 'https://nssu-ekiden.works',
  },
};
...
export default function RootLayout({
  ...
  const sportsTeamSchema = {
    ...
    url: 'https://nssu-ekiden.works',
    logo: 'https://nssu-ekiden.works/wp-content/uploads/2025/02/nssu192.jpg',
  ...
  return (
    <html lang="ja" suppressHydrationWarning={true}>
      <head>
        <link rel="preconnect" href="https://nssu-ekiden.works" crossOrigin="anonymous" />
        <link rel="dns-prefetch" href="https://nssu-ekiden.works" />
