...
const recordsData: { name: string; highSchool: string; record: string; year: number | string | null; recordYear: string; }[] = [
  { name: "富永 椋太", highSchool: "鉾田第一", record: "1:00'56\"", year: 4, recordYear: "2025年" },
  { name: "平島 龍斗", highSchool: "相洋高校", record: "1:01'02\"", year: 3, recordYear: "2025年" },
  { name: "池田 燿平", highSchool: "島田高校", record: "1:01'36\"", year: 3, recordYear: "2020年" },
  { name: "小松 巧弥", highSchool: "倉敷南", record: "1:02'04\"", year: 4, recordYear: "2016年" },
  { name: "田島 駿介", highSchool: "旭野高校", record: "1:02'04\"", year: 3, recordYear: "2025年" },
  { name: "山崎 丞", highSchool: "中越高校", record: "1:02'06\"", year: 2, recordYear: "2023年" },
  { name: "山中 秀仁", highSchool: "興国高校", record: "1:02'09\"", year: 2, recordYear: "2014年" },
  { name: "山口 廉", highSchool: "大牟田", record: "1:02'10\"", year: 4, recordYear: "2024年" },
  { name: "藤本 珠輝", highSchool: "西脇工業", record: "1:02'13\"", year: 2, recordYear: "2020年" },
  { name: "住原 聡太", highSchool: "豊川工業", record: "1:02'19\"", year: 4, recordYear: "2025年" },
  { name: "奥野 翔弥", highSchool: "豊川工業", record: "1:02'26\"", year: 3, recordYear: "2015年" },
  { name: "本田 匠", highSchool: "九州学院", record: "1:02'37\"", year: 2, recordYear: "2012年" },
  { name: "矢野 圭吾", highSchool: "佐久長聖", record: "1:02'38\"", year: 4, recordYear: "2013年" },
  { name: "勝亦 祐太", highSchool: "西脇工業", record: "1:02'39\"", year: 2, recordYear: "2014年" },
  { name: "大森 椋太", highSchool: "玉野光南", record: "1:02'39\"", year: 4, recordYear: "2023年" },
  { name: "分須 尊紀", highSchool: "東農大二", record: "1:02'39\"", year: 4, recordYear: "2025年" },
  { name: "熊本 剛", highSchool: "西脇工業", record: "1:02'43\"", year: 2, recordYear: "2004年" },
  { name: "四辻 聖", highSchool: "報徳高校", record: "1:02'44\"", year: 3, recordYear: "2004年" },
  { name: "小町 昌矢", highSchool: "藤沢翔陵", record: "1:03'00\"", year: 2, recordYear: "2016年" },
  { name: "岩室 天輝", highSchool: "大牟田", record: "1:03'01\"", year: 4, recordYear: "2020年" },
  { name: "吉田 亮壱", highSchool: "大牟田", record: "1:03'02\"", year: 3, recordYear: "2016年" },
  { name: "秋山 清仁", highSchool: "順天高校", record: "1:03'03\"", year: 4, recordYear: "2016年" },
  { name: "小野木 俊", highSchool: "鉾田第一", record: "1:03'03\"", year: 4, recordYear: "2016年" },
  { name: "中川 翔太", highSchool: "九州学院", record: "1:03'04\"", year: 1, recordYear: "2016年" },
  { name: "菅沼 隆佑", highSchool: "榛原高校", record: "1:03'04\"", year: 4, recordYear: "2020年" },
  { name: "木村 勇貴", highSchool: "西京高校", record: "1:03'08\"", year: 4, recordYear: "2014年" },
  { name: "保科 光作", highSchool: "東北高校", record: "1:03'09\"", year: 1, recordYear: "2014年" },
  { name: "福住 賢翔", highSchool: "千原台", record: "1:03'10\"", year: 4, recordYear: "2020年" },
  { name: "山田 紘之", highSchool: "豊川工業", record: "1:03'11\"", year: 2, recordYear: "2002年" },
  { name: "住田 優範", highSchool: "西京高校", record: "1:03'11\"", year: 4, recordYear: "2018年" }
];
...
export default function MenHalfMarathonRecordPage() {
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="mb-6">
        <Breadcrumbs items={[
          ...
          { label: '男子ハーフマラソン 歴代ランキング' }
        ]} />
      </div>
      <AnimatedPageHeader
        title="男子ハーフマラソン 歴代ランキング"
      />
      {/* 他の記録へボタン */}
      ...
      <div className="block md:hidden max-w-2xl mx-auto space-y-3">
        <div className="font-bold text-base text-blue-900 mb-2">男子ハーフマラソン歴代ランキングTOP30</div>
        {records.map((rec, i) => {
          const isNew = rec.recordYear === "2025年";
          return (
            <div
      ...
      <div className="hidden md:block max-w-4xl mx-auto">
        <div className="mb-8 border-gray-200 bg-gray-50 rounded-xl shadow-sm">
          <div className="flex items-center gap-2 px-6 pt-6 pb-2">
            ...
            <span className="text-blue-900 text-xl font-bold">男子ハーフマラソン歴代ランキングTOP30</span>
          </div>
