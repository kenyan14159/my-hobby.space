...
const facilities = [
  ...
  },
  {
    ...
    description: "日本体育大学陸上競技場の400mトラックはブルータータン仕様、ナイター照明付きで、多くの好記録や日本記録が誕生した歴史と伝統ある競技場です。そして毎日300名を超える部員たちが練習しており、今でもその伝統と歴史は引き継がれています。",
  },
];
    ...
    <main className="container mx-auto py-8 px-4 max-w-6xl">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-700">
              このページの情報は参考情報です。入部に関する最新情報は必ず陸上競技部に直接お問い合わせください。
            </p>
          </div>
        </div>
      </Card>
      ...
      <Card className="my-8 p-6 bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
        ...
        <div className="text-sm text-gray-700 space-y-3">
          ...
          <p>
            本学には陸上競技に専念できる環境が十分に揃っています。
            日体大陸上競技部は日本一の部員数を誇り、長い歴史と伝統を引き継いでいます。
            競技力も代表レベルから初心者まで幅広く、各々が刺激し合い様々なことに挑戦しています。
          </p>
          <p className="text-center font-bold text-blue-900 pt-2">
            環境はもう揃っています。あとは君の挑戦次第です。<br />
            貴重な大学4年間を、我が部の仲間として共に過ごしましょう。<br />
          ...
          {blocks.map((block, index) => (
            <Card key={index} className={`p-4 ${block.color} border`}>
              ...
              <div className="grid md:grid-cols-2 gap-3 text-sm">
                <div>
                  <h4 className="font-semibold text-gray-700 mb-1">練習日</h4>
                  <p className="whitespace-pre-line text-gray-600">{block.schedule}</p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-700 mb-1">休日</h4>
                  <p className="text-gray-600">{block.holidays}</p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-700 mb-1">アルバイト</h4>
                  <p className="text-gray-600">{block.partTimeJob}</p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-700 mb-1">施設</h4>
                  <p className="text-gray-600">{block.facilities}</p>
                </div>
              </div>
              <div className="mt-3 text-sm">
                <h4 className="font-semibold text-gray-700 mb-1">雰囲気</h4>
                <p className="text-gray-600">{block.atmosphere}</p>
              </div>
              <div className="bg-white/50 p-3 rounded mt-3 text-sm">
                <h4 className="font-semibold text-gray-700 mb-1">メッセージ</h4>
                <p className="whitespace-pre-line text-gray-600">{block.message}</p>
              </div>
              {block.achievements && (
                <div className="mt-3 bg-white/50 p-3 rounded text-sm">
                  <h4 className="font-semibold text-gray-700 mb-2">主な実績</h4>
      ...
      <section className="my-10">
        <Card className="p-6 bg-gradient-to-br from-yellow-50 to-orange-50 border-orange-200">
          ...
          <div className="space-y-4 text-sm">
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <h3 className="font-semibold text-gray-700 mb-1">活動場所</h3>
                <p className="text-gray-600">日本体育大学横浜健志台キャンパス陸上競技場</p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-700 mb-1">活動日時</h3>
              ...
              <div className="md:col-span-2">
                <h3 className="font-semibold text-gray-700 mb-1">活動時間</h3>
                <div className="text-gray-600 space-y-1">
                  <p>授業期間中: 16:15～</p>
                  <p>休日・休み期間中: 9:00～</p>
                </div>
      ...
      {/* 入部条件 */}
      <Card className="my-10 p-6 bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
        <h2 className="text-2xl font-bold mb-3 text-center">入部条件</h2>
        <p className="text-center font-semibold text-gray-700">
          男女駅伝ブロック以外のブロックでは、入部基準は基本的に設けておりません。
        </p>
      </Card>
