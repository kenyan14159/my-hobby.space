...
// 各カテゴリのデータ（TypeScriptファイルから抽出したデータ）
const allData = {
  "sprint-men": {
    "4年生": [
...
// JSONファイルとして出力
const outputPath = path.join(__dirname, '../public/data/track-field-members/categories.json');
fs.writeFileSync(outputPath, JSON.stringify(allData, null, 2), 'utf8');

console.log('✅ Data migration completed! File saved to:', outputPath);
